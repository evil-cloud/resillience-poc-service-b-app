...
pipeline {
    ...
    environment {
        IMAGE_NAME = "d4rkghost47/python-circuit-svc-2"
        REGISTRY = "https://index.docker.io/v1/"
        SHORT_SHA = "${GIT_COMMIT[0..7]}"
        RECIPIENTS = "reynosojose2005@gmail.com"
        GIT_MANIFESTS_REPO = "git@github.com:evil-cloud/resillience-poc-service-b-k8s.git"
        GIT_MANIFESTS_BRANCH = "main"
        GIT_MANIFESTS_REPO_NAME = "resillience-poc-service-b-k8s" // Repositorio sin prefijo de URL
    }
